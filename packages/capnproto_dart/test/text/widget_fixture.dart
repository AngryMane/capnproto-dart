...
const EnumSchemaInfo colorSchema = EnumSchemaInfo(
  ...
  shortName: 'Color',
  enumerants: [
    EnumerantSchemaInfo(name: 'red', codeOrder: 0, ordinal: 0),
    EnumerantSchemaInfo(name: 'green', codeOrder: 1, ordinal: 1),
    EnumerantSchemaInfo(name: 'blue', codeOrder: 2, ordinal: 2),
  ],
);
