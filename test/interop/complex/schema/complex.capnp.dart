...
const EnumSchemaInfo colorSchema = EnumSchemaInfo(
  ...
  annotations: [
    AnnotationInfo(id: 0xada4ebe6c8867cf0, value: 'enum'),
  ],
);
...
final class AllScalarsReader extends StructReader {
  ...
  String? get textValue => getTextField(0, defaultValue: 'hello from complex.capnp');

  Uint8List? get dataValue => getDataField(1, defaultValue: Uint8List.fromList([0, 1, 2, 3, 127, 128, 254, 255]));
...
const StructSchemaInfo allScalarsSchema = StructSchemaInfo(
  ...
  fields: [
    ...
    FieldSchemaInfo(
      ...
      body: SlotFieldSchemaInfo(
        ...
        hadExplicitDefault: true,
        defaultValue: 'hello from complex.capnp',
      ),
    ),
    FieldSchemaInfo(
      name: 'dataValue',
      ...
      body: SlotFieldSchemaInfo(
        ...
        hadExplicitDefault: true,
        defaultValue: const [0, 1, 2, 3, 127, 128, 254, 255],
      ),
    ),
    FieldSchemaInfo(
      name: 'color',
  ...
  annotations: [
    AnnotationInfo(id: 0xada4ebe6c8867cf0, value: 'all-scalars'),
  ],
);
...
const StructSchemaInfo personSchema = StructSchemaInfo(
  ...
  annotations: [
    AnnotationInfo(id: 0xada4ebe6c8867cf0, value: 'nested-types'),
  ],
);
...
class ObserverClient<Event> extends Capability {
  ...
  Future<ObserverOnNextResultsReader> onNextTyped(AnyPointerCodec<Event> eventCodec, Event event) async {
    ...
    final result = dispatchResult.payload.getTyped(observerOnNextResultsFactory, capabilities: dispatchResult.caps);
    return result;
  }
...
class ObserverClientFactory<Event> extends CapabilityFactory<ObserverClient<Event>> {
  @override
  ObserverClient<Event> fromCapability(Capability cap) => ObserverClient<Event>(cap);
}
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0xf67686e607b37dbb:
        switch (methodId) {
          case 0:
            final p = params.getTyped(observerOnNextParamsFactory, capabilities: paramsCapabilities);
            await onNextWithContext(p, paramsCapabilities, dispatchContext);
            return DispatchResult.empty;
          case 1:
            final p = params.getTyped(observerOnErrorParamsFactory, capabilities: paramsCapabilities);
            await onErrorWithContext(p, paramsCapabilities, dispatchContext);
            return DispatchResult.empty;
          case 2:
            final p = params.getTyped(observerOnCompleteParamsFactory, capabilities: paramsCapabilities);
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0xe23251fe94e836ec:
        switch (methodId) {
          case 0:
            final p = params.getTyped(subscriptionCancelParamsFactory, capabilities: paramsCapabilities);
            return await cancelWithContext(p, paramsCapabilities, dispatchContext);
          case 1:
            final p = params.getTyped(subscriptionGetIdParamsFactory, capabilities: paramsCapabilities);
...
class ReadableClient<Value> extends Capability {
...
class ReadableClientFactory<Value> extends CapabilityFactory<ReadableClient<Value>> {
  @override
  ReadableClient<Value> fromCapability(Capability cap) => ReadableClient<Value>(cap);
}
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0xa69434bbd537a649:
        switch (methodId) {
          case 0:
            final p = params.getTyped(readableReadParamsFactory, capabilities: paramsCapabilities);
...
class WritableClient<Value> extends Capability {
  ...
  Future<WritableWriteResultsReader> writeTyped(AnyPointerCodec<Value> valueCodec, Value value) async {
    ...
    final result = dispatchResult.payload.getTyped(writableWriteResultsFactory, capabilities: dispatchResult.caps);
    return result;
  }
...
class WritableClientFactory<Value> extends CapabilityFactory<WritableClient<Value>> {
  @override
  WritableClient<Value> fromCapability(Capability cap) => WritableClient<Value>(cap);
}
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0xd4bab7c88d024c5e:
        switch (methodId) {
          case 0:
            final p = params.getTyped(writableWriteParamsFactory, capabilities: paramsCapabilities);
...
class ReadWriteClient<Value> extends Capability {
  ...
  Future<Value?> compareAndSwapTyped(AnyPointerCodec<Value> valueCodec, Value expected, Value replacement) async {
    ...
    final result = dispatchResult.payload.getTyped(readWriteCompareAndSwapResultsFactory, capabilities: dispatchResult.caps);
    return result.getActualTyped(valueCodec);
  }
...
class ReadWriteClientFactory<Value> extends CapabilityFactory<ReadWriteClient<Value>> {
  @override
  ReadWriteClient<Value> fromCapability(Capability cap) => ReadWriteClient<Value>(cap);
}
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      ...
      case 0xc2108261d371f6f8:
        switch (methodId) {
          case 0:
            final p = params.getTyped(readWriteCompareAndSwapParamsFactory, capabilities: paramsCapabilities);
...
class CursorClient<Value> extends Capability {
...
class CursorClientFactory<Value> extends CapabilityFactory<CursorClient<Value>> {
  @override
  CursorClient<Value> fromCapability(Capability cap) => CursorClient<Value>(cap);
}
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0x8384e36911992a84:
        switch (methodId) {
          case 0:
            final p = params.getTyped(cursorNextParamsFactory, capabilities: paramsCapabilities);
...
final class RepositoryOpenCursorResult {
  RepositoryOpenCursorResult._(DispatchResult dispatchResult)
    ...
    result = dispatchResult.payload.getTyped(repositoryOpenCursorResultsFactory, capabilities: dispatchResult.caps);
...
final class RepositoryWatchResult {
  RepositoryWatchResult._(DispatchResult dispatchResult)
    ...
    result = dispatchResult.payload.getTyped(repositoryWatchResultsFactory, capabilities: dispatchResult.caps);
...
class RepositoryClient<Key, Value> extends Capability {
  ...
  Future<RepositoryGetResultsReader> getTyped(AnyPointerCodec<Key> keyCodec, Key key) async {
    ...
    final result = dispatchResult.payload.getTyped(repositoryGetResultsFactory, capabilities: dispatchResult.caps);
    return result;
  }
  ...
  Future<RepositoryPutResultsReader> putTyped(AnyPointerCodec<Key> keyCodec, AnyPointerCodec<Value> valueCodec, Key key, Value value) async {
    ...
    final result = dispatchResult.payload.getTyped(repositoryPutResultsFactory, capabilities: dispatchResult.caps);
    return result;
  }
  ...
  Future<RepositoryRemoveResultsReader> removeTyped(AnyPointerCodec<Key> keyCodec, Key key) async {
    ...
    final result = dispatchResult.payload.getTyped(repositoryRemoveResultsFactory, capabilities: dispatchResult.caps);
    return result;
  }
...
class RepositoryClientFactory<Key, Value> extends CapabilityFactory<RepositoryClient<Key, Value>> {
  @override
  RepositoryClient<Key, Value> fromCapability(Capability cap) => RepositoryClient<Key, Value>(cap);
}
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0xff065518e00ba453:
        switch (methodId) {
          case 0:
            final p = params.getTyped(repositoryGetParamsFactory, capabilities: paramsCapabilities);
            return await getWithContext(p, paramsCapabilities, dispatchContext);
          case 1:
            final p = params.getTyped(repositoryPutParamsFactory, capabilities: paramsCapabilities);
            return await putWithContext(p, paramsCapabilities, dispatchContext);
          case 2:
            final p = params.getTyped(repositoryRemoveParamsFactory, capabilities: paramsCapabilities);
            return await removeWithContext(p, paramsCapabilities, dispatchContext);
          case 3:
            final p = params.getTyped(repositoryListParamsFactory, capabilities: paramsCapabilities);
            return await listWithContext(p, paramsCapabilities, dispatchContext);
          case 4:
            final p = params.getTyped(repositoryOpenCursorParamsFactory, capabilities: paramsCapabilities);
            return await openCursorWithContext(p, paramsCapabilities, dispatchContext);
          case 5:
            final p = params.getTyped(repositoryWatchParamsFactory, capabilities: paramsCapabilities);
...
class ByteSinkClient extends Capability {
  ...
  Future<void> write(void Function(ByteSinkWriteParamsBuilder) build) async {
    ...
    await _cap.dispatchStreaming(0xbef98c1dd8be91de, 0, RpcPayload.fromBytes(mb.serialize()));
  }
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0xbef98c1dd8be91de:
        switch (methodId) {
          case 0:
            final p = params.getTyped(byteSinkWriteParamsFactory, capabilities: paramsCapabilities);
            await writeWithContext(p, paramsCapabilities, dispatchContext);
            return DispatchResult.empty;
          case 1:
            final p = params.getTyped(byteSinkFinishParamsFactory, capabilities: paramsCapabilities);
            return await finishWithContext(p, paramsCapabilities, dispatchContext);
          case 2:
            final p = params.getTyped(byteSinkAbortParamsFactory, capabilities: paramsCapabilities);
...
class ByteSourceClient extends Capability {
  ...
  Future<ByteSourcePumpToResultsReader> pumpTo(void Function(ByteSourcePumpToParamsBuilder) build, {required Capability sink}) async {
    ...
    return result.payload.getTyped(byteSourcePumpToResultsFactory, capabilities: result.caps);
  }
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0x8a2b2ec8ae50b170:
        switch (methodId) {
          case 0:
            final p = params.getTyped(byteSourcePumpToParamsFactory, capabilities: paramsCapabilities);
...
final class CapabilityFactoryNewCellResult {
  CapabilityFactoryNewCellResult._(DispatchResult dispatchResult)
    ...
    result = dispatchResult.payload.getTyped(capabilityFactoryNewCellResultsFactory, capabilities: dispatchResult.caps);
...
final class CapabilityFactoryNewEmptyCellResult {
  CapabilityFactoryNewEmptyCellResult._(DispatchResult dispatchResult)
      :     cell = ReadWriteClient(requireCapabilityFromResult(dispatchResult, 0)),
    result = dispatchResult.payload.getTyped(capabilityFactoryNewEmptyCellResultsFactory, capabilities: dispatchResult.caps);
...
final class CapabilityFactoryNewRepositoryResult {
  CapabilityFactoryNewRepositoryResult._(DispatchResult dispatchResult)
    ...
    result = dispatchResult.payload.getTyped(capabilityFactoryNewRepositoryResultsFactory, capabilities: dispatchResult.caps);
...
class CapabilityFactoryClient extends Capability {
  ...
  Future<Cap?> echoCapabilityTyped<Cap>(AnyPointerCodec<Cap> capCodec, Cap capability) async {
    ...
    final result = dispatchResult.payload.getTyped(capabilityFactoryEchoCapabilityResultsFactory, capabilities: dispatchResult.caps);
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0xccad478715fb03b0:
        switch (methodId) {
          case 0:
            final p = params.getTyped(capabilityFactoryNewCellParamsFactory, capabilities: paramsCapabilities);
            return await newCellWithContext(p, paramsCapabilities, dispatchContext);
          case 1:
            final p = params.getTyped(capabilityFactoryNewEmptyCellParamsFactory, capabilities: paramsCapabilities);
            return await newEmptyCellWithContext(p, paramsCapabilities, dispatchContext);
          case 2:
            final p = params.getTyped(capabilityFactoryNewRepositoryParamsFactory, capabilities: paramsCapabilities);
            return await newRepositoryWithContext(p, paramsCapabilities, dispatchContext);
          case 3:
            final p = params.getTyped(capabilityFactoryEchoCapabilityParamsFactory, capabilities: paramsCapabilities);
            return await echoCapabilityWithContext(p, paramsCapabilities, dispatchContext);
          case 4:
            final p = params.getTyped(capabilityFactoryGetUntypedParamsFactory, capabilities: paramsCapabilities);
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0x882e0e49903e08ff:
        switch (methodId) {
          case 0:
            final p = params.getTyped(parentGetNameParamsFactory, capabilities: paramsCapabilities);
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      ...
      case 0xdc9405e2c5728627:
        switch (methodId) {
          case 0:
            final p = params.getTyped(leftLeftParamsFactory, capabilities: paramsCapabilities);
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      ...
      case 0xc43c47560508dc7d:
        switch (methodId) {
          case 0:
            final p = params.getTyped(rightRightParamsFactory, capabilities: paramsCapabilities);
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      ...
      case 0xdbf219de6a215361:
        switch (methodId) {
          case 0:
            final p = params.getTyped(diamondBothParamsFactory, capabilities: paramsCapabilities);
...
final class PipelineTargetGetChildResult {
  PipelineTargetGetChildResult._(DispatchResult dispatchResult)
    ...
    result = dispatchResult.payload.getTyped(pipelineTargetGetChildResultsFactory, capabilities: dispatchResult.caps);
...
final class PipelineTargetGetRepositoryResult {
  PipelineTargetGetRepositoryResult._(DispatchResult dispatchResult)
      :     repository = RepositoryClient(requireCapabilityFromResult(dispatchResult, 0)),
    result = dispatchResult.payload.getTyped(pipelineTargetGetRepositoryResultsFactory, capabilities: dispatchResult.caps);
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0xe211443879f3b6bb:
        switch (methodId) {
          case 0:
            final p = params.getTyped(pipelineTargetGetChildParamsFactory, capabilities: paramsCapabilities);
            return await getChildWithContext(p, paramsCapabilities, dispatchContext);
          case 1:
            final p = params.getTyped(pipelineTargetGetRepositoryParamsFactory, capabilities: paramsCapabilities);
            return await getRepositoryWithContext(p, paramsCapabilities, dispatchContext);
          case 2:
            final p = params.getTyped(pipelineTargetPingParamsFactory, capabilities: paramsCapabilities);
...
final class ComplexTestServiceEchoResult {
  ComplexTestServiceEchoResult._(DispatchResult dispatchResult)
      :     result = dispatchResult.payload.getTyped(complexTestServiceEchoResultsFactory, capabilities: dispatchResult.caps);

  final ComplexTestServiceEchoResultsReader result;
}
...
final class ComplexTestServiceEchoPipeline {
  ...
  final Future<ComplexTestServiceEchoResultsReader> result;
  final ComplexResponsePipeline response;
}

final class ComplexTestServiceExchangeCapabilitiesResult {
  ComplexTestServiceExchangeCapabilitiesResult._(DispatchResult dispatchResult)
      :     result = dispatchResult.payload.getTyped(complexTestServiceExchangeCapabilitiesResultsFactory, capabilities: dispatchResult.caps);

  final ComplexTestServiceExchangeCapabilitiesResultsReader result;
}
...
final class ComplexTestServiceExchangeCapabilitiesPipeline {
  ...
  final Future<ComplexTestServiceExchangeCapabilitiesResultsReader> result;
  final CapabilityBundlePipeline bundle;
}
...
final class ComplexTestServiceMakePipelineResult {
  ComplexTestServiceMakePipelineResult._(DispatchResult dispatchResult)
    ...
    result = dispatchResult.payload.getTyped(complexTestServiceMakePipelineResultsFactory, capabilities: dispatchResult.caps);
...
final class ComplexTestServiceOpenUploadResult {
  ComplexTestServiceOpenUploadResult._(DispatchResult dispatchResult)
    ...
    result = dispatchResult.payload.getTyped(complexTestServiceOpenUploadResultsFactory, capabilities: dispatchResult.caps);
...
final class ComplexTestServiceOpenDownloadResult {
  ComplexTestServiceOpenDownloadResult._(DispatchResult dispatchResult)
    ...
    result = dispatchResult.payload.getTyped(complexTestServiceOpenDownloadResultsFactory, capabilities: dispatchResult.caps);
...
final class ComplexTestServiceGetRepositoryResult {
  ComplexTestServiceGetRepositoryResult._(DispatchResult dispatchResult)
      :     repository = RepositoryClient(requireCapabilityFromResult(dispatchResult, 0)),
    result = dispatchResult.payload.getTyped(complexTestServiceGetRepositoryResultsFactory, capabilities: dispatchResult.caps);
...
final class ComplexTestServiceGetFactoryResult {
  ComplexTestServiceGetFactoryResult._(DispatchResult dispatchResult)
    ...
    result = dispatchResult.payload.getTyped(complexTestServiceGetFactoryResultsFactory, capabilities: dispatchResult.caps);
...
final class ComplexTestServiceMakePromisedPipelineResult {
  ComplexTestServiceMakePromisedPipelineResult._(DispatchResult dispatchResult)
      :     target = PipelineTargetClient(requireCapabilityFromResult(dispatchResult, 0)),
    result = dispatchResult.payload.getTyped(complexTestServiceMakePromisedPipelineResultsFactory, capabilities: dispatchResult.caps);
...
final class ComplexTestServiceEchoPipelineTargetLaterResult {
  ComplexTestServiceEchoPipelineTargetLaterResult._(DispatchResult dispatchResult)
      :     target = PipelineTargetClient(requireCapabilityFromResult(dispatchResult, 0)),
    result = dispatchResult.payload.getTyped(complexTestServiceEchoPipelineTargetLaterResultsFactory, capabilities: dispatchResult.caps);
...
class ComplexTestServiceClient extends Capability {
  ...
  Future<Value?> echoAnyPointerTyped<Value>(AnyPointerCodec<Value> valueCodec, Value value) async {
    ...
    final result = dispatchResult.payload.getTyped(complexTestServiceEchoAnyPointerResultsFactory, capabilities: dispatchResult.caps);
    return result.getValueTyped(valueCodec);
  }
  ...
  Future<ComplexTestServiceCallObserverResultsReader> callObserver(void Function(ComplexTestServiceCallObserverParamsBuilder) build, {required Capability observer}) async {
    ...
    return result.payload.getTyped(complexTestServiceCallObserverResultsFactory, capabilities: result.caps);
  }
  ...
  Future<ComplexTestServiceUseDiamondResultsReader> useDiamond(void Function(ComplexTestServiceUseDiamondParamsBuilder) build, {required Capability diamond}) async {
    ...
    return result.payload.getTyped(complexTestServiceUseDiamondResultsFactory, capabilities: result.caps);
  }
  ...
  Future<ComplexTestServiceProbePipelineTargetResultsReader> probePipelineTarget(void Function(ComplexTestServiceProbePipelineTargetParamsBuilder) build, {required Capability target}) async {
    ...
    return result.payload.getTyped(complexTestServiceProbePipelineTargetResultsFactory, capabilities: result.caps);
  }
...
const InterfaceSchemaInfo complexTestServiceSchema = InterfaceSchemaInfo(
  ...
  annotations: [
    AnnotationInfo(id: 0xada4ebe6c8867cf0, value: 'rpc-root'),
  ],
);
  ...
  Future<DispatchResult> dispatchWithContext(int interfaceId, int methodId, RpcPayload params, {
    ...
    switch (interfaceId) {
      case 0xd7fb0472c16375ee:
        switch (methodId) {
          case 0:
            final p = params.getTyped(complexTestServiceEchoParamsFactory, capabilities: paramsCapabilities);
            return await echoWithContext(p, paramsCapabilities, dispatchContext);
          case 1:
            final p = params.getTyped(complexTestServiceEchoScalarsParamsFactory, capabilities: paramsCapabilities);
            return await echoScalarsWithContext(p, paramsCapabilities, dispatchContext);
          case 2:
            final p = params.getTyped(complexTestServiceEchoListsParamsFactory, capabilities: paramsCapabilities);
            return await echoListsWithContext(p, paramsCapabilities, dispatchContext);
          case 3:
            final p = params.getTyped(complexTestServiceEchoUnionParamsFactory, capabilities: paramsCapabilities);
            return await echoUnionWithContext(p, paramsCapabilities, dispatchContext);
          case 4:
            final p = params.getTyped(complexTestServiceEchoAnyPointerParamsFactory, capabilities: paramsCapabilities);
            return await echoAnyPointerWithContext(p, paramsCapabilities, dispatchContext);
          case 5:
            final p = params.getTyped(complexTestServiceExchangeCapabilitiesParamsFactory, capabilities: paramsCapabilities);
            return await exchangeCapabilitiesWithContext(p, paramsCapabilities, dispatchContext);
          case 6:
            final p = params.getTyped(complexTestServiceCallObserverParamsFactory, capabilities: paramsCapabilities);
            return await callObserverWithContext(p, paramsCapabilities, dispatchContext);
          case 7:
            final p = params.getTyped(complexTestServiceMakePipelineParamsFactory, capabilities: paramsCapabilities);
            return await makePipelineWithContext(p, paramsCapabilities, dispatchContext);
          case 8:
            final p = params.getTyped(complexTestServiceOpenUploadParamsFactory, capabilities: paramsCapabilities);
            return await openUploadWithContext(p, paramsCapabilities, dispatchContext);
          case 9:
            final p = params.getTyped(complexTestServiceOpenDownloadParamsFactory, capabilities: paramsCapabilities);
            return await openDownloadWithContext(p, paramsCapabilities, dispatchContext);
          case 10:
            final p = params.getTyped(complexTestServiceGetRepositoryParamsFactory, capabilities: paramsCapabilities);
            return await getRepositoryWithContext(p, paramsCapabilities, dispatchContext);
          case 11:
            final p = params.getTyped(complexTestServiceGetFactoryParamsFactory, capabilities: paramsCapabilities);
            return await getFactoryWithContext(p, paramsCapabilities, dispatchContext);
          case 12:
            final p = params.getTyped(complexTestServiceUseDiamondParamsFactory, capabilities: paramsCapabilities);
            return await useDiamondWithContext(p, paramsCapabilities, dispatchContext);
          case 13:
            final p = params.getTyped(complexTestServiceFailIntentionallyParamsFactory, capabilities: paramsCapabilities);
            await failIntentionallyWithContext(p, paramsCapabilities, dispatchContext);
            return DispatchResult.empty;
          case 14:
            final p = params.getTyped(complexTestServiceShutdownParamsFactory, capabilities: paramsCapabilities);
            await shutdownWithContext(p, paramsCapabilities, dispatchContext);
            return DispatchResult.empty;
          case 15:
            final p = params.getTyped(complexTestServiceProbePipelineTargetParamsFactory, capabilities: paramsCapabilities);
            return await probePipelineTargetWithContext(p, paramsCapabilities, dispatchContext);
          case 16:
            final p = params.getTyped(complexTestServiceMakePromisedPipelineParamsFactory, capabilities: paramsCapabilities);
            return await makePromisedPipelineWithContext(p, paramsCapabilities, dispatchContext);
          case 17:
            final p = params.getTyped(complexTestServiceEchoPipelineTargetLaterParamsFactory, capabilities: paramsCapabilities);
...
const String defaultGreeting = 'hello from complex.capnp';
final Uint8List defaultBlob = Uint8List.fromList([0, 1, 2, 3, 127, 128, 254, 255]);
const int defaultSigned = -9223372036854775807;
const int defaultUnsigned = -1;
const double defaultFloat = 3.141592653589793;
