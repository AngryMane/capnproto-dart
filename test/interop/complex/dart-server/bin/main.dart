...
class DartComplexServiceImpl extends ComplexTestServiceServer {
  ...
  Future<DispatchResult> exchangeCapabilities(
    ...
    print(
      '[dart-server] exchangeCapabilities(targets=${targets?.length ?? 0})',
    );
...
Future<void> main() async {
  ...
  final server = await RpcSystem.serve(Uri.parse('tcp://127.0.0.1:$port'), svc);
